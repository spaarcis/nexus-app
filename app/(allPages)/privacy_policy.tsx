        ...
        <View style={tw`flex-1`}>
            ...
            <View style={tw`pt-12 px-6 pb-6`}>
                ...
                <View style={tw`flex-row items-center mb-2`}>
                    ...
                    <Text style={tw`text-white text-2xl font-poppinsBold ml-3`}>Privacy Policy</Text>
                </View>
            ...
            <ScrollView style={tw`flex-1 px-6`} showsVerticalScrollIndicator={false}>
                {/* Section 1 */}
                <View style={tw`mb-8`}>
                    <Text style={tw`text-white text-lg font-poppinsBold mb-4`}>1. Introduction</Text>
                ...
                {/* Section 2 */}
                <View style={tw`mb-8`}>
                    <Text style={tw`text-white text-lg font-poppinsBold mb-4`}>2. Information We Collect</Text>
                    <Text style={tw`text-gray-300 text-base font-poppinsRegular leading-6`}>
                        Lorem ipsum dolor sit amet consectetur. Volutpat purus nunc tellus lorem adipiscing. Convallis at mi
                        dictumst nulla amet. Ipsum consequat vel donec ut amet ante semper. Amet tempus tellus aliquam volutpat enim
                        dolor tristique.
                ...
                {/* Section 3 */}
                <View style={tw`mb-8`}>
                    <Text style={tw`text-white text-lg font-poppinsBold mb-4`}>3. Data Security</Text>
                    <Text style={tw`text-gray-300 text-base font-poppinsRegular leading-6`}>
                        Lorem ipsum dolor sit amet consectetur. Volutpat purus nunc tellus lorem adipiscing. Convallis at mi
                        dictumst nulla amet. Ipsum consequat vel donec ut amet ante semper. Amet tempus tellus aliquam volutpat enim
                        dolor tristique.
