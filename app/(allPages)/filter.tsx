...
const Filter = () => {
  ...
  const handleDateChange = (event: any, date?: Date) => {
    if (date) {
      const formatted = date.toISOString().split("T")[0]; // 2025-08-21 format
  ...
  return (
    <View style={tw`flex-1 px-5`}>
      ...
      <View style={tw`flex-1 justify-between`}>
        <View>
          {/* Location */}
          <Text style={tw`text-primary text-base font-poppinsSemiBold mb-3`}>
            Location
          </Text>
          <View
        ...
        <TouchableOpacity
          ...
          onPress={() => {
            router.push({
              pathname: "/(allPages)/afterFilterPage",
              params: { location, date: selectedDate },
            });
          }}
        >
