                                ...
                                <View style={[tw`flex-col items-center justify-between`, {
                                    ...
                                    <View>
                                        ...
                                        <View
                                            style={tw` pb-14 `}
                                        >
                                            <Text style={tw`font-poppinsBlack mx-auto text-3xl pt-8 text-primary`}>
                                                Register now
                                            </Text>
                                        ...
                                        <View style={tw`  rounded-t-[40px]`}>
                                            ...
                                            {/* login from */}
                                            <View>
                                                <Text style={tw`text-primary font-poppinsSemiBold text-base pl-2 pt-5 pb-2`}>Full Name</Text>
                                                <View style={tw` rounded-2xl relative overflow-hidden`}>
                                                    ...
                                                    <View style={tw`absolute w-full flex-row items-center justify-start px-4`}>
                                                        ...
                                                        <TextInput
                                                            ...
                                                            onChangeText={(txt) => setFieldValue("fullName", txt)}
                                                        />
                                                    </View>
                                                </View>
                                                {errors.fullName && (
