    ...
    return (
        ...
        >
            <View style={tw`flex-1 bg-black/50 justify-center items-center px-6`}>
                <View style={tw`bg-black rounded-2xl p-6 w-full max-w-sm border border-gray-700`}>
                    {/* Header */}
                    <View style={tw`items-center mb-6`}>
                        <View style={tw`w-12 h-12 bg-red-500/20 rounded-full items-center justify-center mb-3`}>
                            <Text style={tw`text-red-500 text-2xl`}>⚠️</Text>
                        </View>
                        <Text style={tw`text-white text-xl font-poppinsBold text-center`}>
                            Delete Account?
                        </Text>
                        <Text style={tw`text-gray-400 text-sm text-center font-poppins mt-2`}>
                    ...
                    <View style={tw`flex-row gap-5`}>
                        ...
                        <TouchableOpacity
                            ...
                            style={tw`flex-1 items-center relative ${isLoading ? 'opacity-50' : ''}`}
                            disabled={isLoading}
                        >
